...
public class SSSkillEffect_Move extends SSSkillEffect implements ISSMoveObjectHolder
{
	...
	public CVector2D moveDir;
	public CVector2D lastMovePos;
	public CVector2D moveTargetPos;
	...
	public boolean Begin() 
	{
		...
		case Absolute:
			...
			CVector2D nowPos = theOwner.GetCurPos();
			CVector2D nowDist = CVector2D.Sub(moveTargetPos, nowPos) ;
	...
	public boolean ResetPos(SSGameUnit _theOwner,CVector2D pos, CVector2D dir,boolean bIfEnd,boolean bIfCheckCollider,boolean bFindForward)
	{
		if (_theOwner == null)
		{
			return false;
	...
	public boolean Update(long now, long tick)
	{
		...
		case Absolute:
			...
			CVector2D moveVec = CVector2D.Sub(this.moveTargetPos , theOwner.GetCurPos());
	 ...
	 * @param startPos
	 */
	public void StartMove(CVector2D startPos)
	{
